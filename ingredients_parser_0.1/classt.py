...
class EWGSkindeepAPI:
    ...
    def get_ingredient_data(self, search_term, exact_match_only=False):
        ...
        result["exact_match"] = search_term.lower() == ingredient_name.lower()
...
class IngredientAnalyzer:
    ...
    def preprocess_ingredient_list(self, ingredient_list):
        """
        Preprocess raw ingredient list from OCR

        Args:
            ingredient_list (list): Raw list of ingredients from OCR

        Returns:
            list: Cleaned list of ingredients
        """
        cleaned_list = []
        ...
        for item in ingredient_list:
            ...
            item = re.sub(r"^ingredients:?\s*", "", item, flags=re.IGNORECASE)
    ...
    def smart_analyze_list(self, ingredient_list):
        ...
        """
        # Clean the ingredient list first
        cleaned_list = self.preprocess_ingredient_list(ingredient_list)
        ...
        for ingredient in cleaned_list:
...
if __name__ == "__main__":
    ...
    ingredient_list = extract_txt("product_images/image1.jpeg")
    # Analyze ingredients
    analysis_results = analyzer.smart_analyze_list(ingredient_list)
